...
{	
	...
	printf("Hello, this program is morse translator\n");
	//commands
	do {  //loop do-while that roll program(EOP)
		printf("Enter name of command:\n1.load_cmf_and_print_text\n2.load_cmf_and_save_text\n3.load_text_and_print_cmf\n4.load_text_and_save_cmf\n5.translate_text_and_print_cmf\n6.print_format_name\n7.quit\n");
